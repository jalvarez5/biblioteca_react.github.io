    ...
    return (
        <React.Fragment>
            <div className='card-row'>
                ...
                <Card autor="Gabriel Garcia márquez" imagen={"https://www.penguinlibros.com/es/3921788-thickbox_default/en-agosto-nos-vemos.jpg"} descripcion="Cada mes de agosto Ana Magdalena Bach toma el transbordador hasta la isla donde está enterrada su madre para visitar la tumba en la que yace. Esas visitas acaban suponiendo una irresistible invitación a convertirse en una persona distinta durante una noche al año." />
